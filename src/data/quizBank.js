...
export const lessonMeta = [
  ...
  { id:6, num:'06', title:'SVD奇异值分解', en:'Singular Value Decomposition', week:2, path:'/lesson/06', icon:'💎', anims:2, desc:'奇异值、SVD几何意义（旋转-拉伸-旋转）、Frobenius范数、低秩逼近。', tags:['SVD','奇异值','低秩逼近'] },
  { id:7, num:'07', title:'满秩分解与MP逆', en:'Full Rank Decomposition & MP Inverse', week:2, path:'/lesson/07', icon:'🔮', anims:4, desc:'满秩分解、{1}-逆、四个Penrose方程、广义逆唯一性、SVD构造、极小范数最小二乘解。', tags:['满秩分解','广义逆','Penrose方程'] },
